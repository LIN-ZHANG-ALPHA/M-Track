...
try:
        ...
        QtGui.QMessageBox.critical(None, "Error Warning!",
                "Check the eidtion of the Python and Qt4-Phonon",
...
class MainWindow(QtGui.QMainWindow):
    def __init__(self, QtMouseTracker,parent = None):
        ...
        self.centralWidget.setMinimumSize(100,600)
        ...
        self.outputvideoname = []  # for the splited video file name
...
#        self.Box_Size_ScrollBar.valueChanged['int'].connect(self.Box_Size_spinBox.setValue)
        ...
        #self.Draw_LF_Roi_pushButton.clicked.connect(self.independent_roi)
    ...
    # def roiLable_check(self):
    #     if self.child == None:
    #         #self.child = independentView(self.roiLabel,self)
    #         self.child =  independentView(self.displayLabel,self.Tracker,self.zoom,self.roiLabel)
    #         self.child.show()
    #         #self.child.raise_()
...
#        self.Box_Size_spinBox.setDisabled(True)
    ...
    def independent(self):
         self.indenview = independentView(self.displayLabel,self.Tracker)
         self.indenview.show()

    # def independent_roi(self):
    #
    #     self.indenview2 = independentView2(self.displayLabel,self.Tracker,self.roiLabel)
    #     self.indenview2.show()




class independentView(QtGui.QMainWindow):
    def __init__(self, displayLabel,Tracker,parent = None):
        super(independentView, self).__init__(parent)

        self.displayLabel = displayLabel
        self.Tracker = Tracker
        #self.zoom    = zoom
        #self.roiLabel = MainWindow.roiLabel
        # self.roiLabel = roiLabel        #
        # print "roi", self.roiLabel
        ...
        ###### show video and processing here
        ...
        self.resize(self.img_width+25, self.img_height+20)
        self.setWindowTitle(self.tr("VideoProcess"))
        self.show()

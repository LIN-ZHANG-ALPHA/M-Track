...
class MTrack_Qt(object):
    ...
    def buttonAction_loadVideo(self):
        ...
        #self.displayLabel.setGeometry(QtCore.QRect(0, 0, self.height, self.width))
        ...
        #print self.displayLabel.size()
        # print QtCore.Qt.KeepAspectRatio

        # self.video_id = self.videoWidget.winId()  # get the frame of video
        # self.originalPixmap = QtGui.QPixmap.grabWindow(self.video_id)
        # self.scaledSize = self.originalPixmap.size()
        #self.scaledSize.scale(self.displayLabel.size(), QtCore.Qt.KeepAspectRatio)
